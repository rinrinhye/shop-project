...
const Cart = () => {
  ...
  return (
    <div className='main pb-30'>
      <h2 className=' my-10 font-[Outfit] font-bold text-center text-4xl'>
        Cart
      </h2>
      {cartItems.length !== 0 && (
        <>
          ...
          <div className=' lg:flex lg:items-start lg:gap-8'>
            ...
            <div className='lg:w-200 lg:sticky lg:top-5'>
              ...
              <div className='hidden lg:flex lg:gap-3 lg:mt-4'>
                <button
                  type='button'
                  className='button button-lg grow rounded-4xl'
                >
                  선택 상품 주문
                </button>
                <button
                  type='button'
                  className='button button-lg grow rounded-4xl bg-black text-white'
                >
                  전체 상품 주문
                </button>
              </div>
      ...
      {cartItems.length === 0 && (
        <p className='text-center font-[Outfit]'>장바구니가 비었습니다.</p>
      )}
      <div className='fixed bottom-0 left-0 flex gap-4 px-4 py-4 w-full bg-white shadow-[0_-4px_5px_-4px_rgb(0_0_0/.18)] lg:hidden'>
        ...
        <button
          type='button'
          className='button button-lg grow bg-black text-white'
        >
          전체 상품 주문
        </button>
      </div>
