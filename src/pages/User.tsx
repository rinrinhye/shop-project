    ...
    <div className='main flex flex-col gap-4 md:flex-row md:gap-10'>
      <div className='flex flex-col items-center'>
        ...
        <div className='mt-2'>
          <button
            type='button'
            className='px-2 text-[#666666] underline underline-offset-2 text-sm'
          >
            delete
          </button>
        </div>
        <form action='' onSubmit={handleSubmit(onSubmit)}>
          ...
          {!isEditing && (
            <button
              type='button'
              className='button block py-1 mt-4 mx-auto px-10'
              onClick={handleEdit}
            >
              edit
            </button>
          ...
          {isEditing && (
            <div className='flex mt-4 justify-center gap-3'>
              <button
                type='button'
                className='button block py-1 px-6.5'
              ...
              <button
                type='submit'
                className='button button-black block py-1 px-8'
              >
                save
              </button>
            </div>
